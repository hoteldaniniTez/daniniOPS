                        ...
                        <div className="p-8 space-y-6">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-black uppercase text-zinc-400 ml-2 tracking-widest">Contraseña</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                type="password"
                                                className={`w-full pl-12 pr-4 py-3.5 bg-zinc-50 border rounded-2xl text-sm outline-none transition-all ${errors.password ? 'border-red-500' : 'border-zinc-100 focus:bg-white focus:border-zinc-900'}`}
                                            />
                                        </div>
                                        {errors.password && <p className="text-red-500 text-[9px] font-bold ml-2 uppercase">{errors.password.message}</p>}
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-black uppercase text-zinc-400 ml-2 tracking-widest">Rol</label>
                                        <select
                                            {...register('role', { required: true })}
                                            className="w-full px-4 py-3.5 bg-zinc-50 border border-zinc-100 rounded-2xl text-sm outline-none focus:bg-white focus:border-zinc-900 transition-all font-bold text-zinc-600 appearance-none cursor-pointer"
                                        >
